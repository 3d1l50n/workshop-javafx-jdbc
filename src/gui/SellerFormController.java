...
public class SellerFormController implements Initializable {
	...
	public void setServices(SellerService sellerService, DepartamentService departamentService) {
	...
	private Seller getFormData() {
		...
		ValidationException exception = new ValidationException("Validation Error Exception");
	...
	public void loadAssociatedObjects() {
		if(departamentService == null) {
			throw new IllegalStateException("Departament was null");
		}
